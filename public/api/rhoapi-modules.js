...
if (typeof(qt) == "undefined"){
    ...
    var bridgeMapping = [
        ...
        [/iPhone|iPod|iPad/                , bridges[rhoPlatform.id.AJAX]        ],
    ...
    rhoPlatform.nativeApiCall = function() {
        ...
        var platformBridge = detectedPlatformBridge;
        if (rhoUtil.flag.NATIVE_BRIDGE_TYPE in window) {
            var btype = window[rhoUtil.flag.NATIVE_BRIDGE_TYPE];
            if (btype in bridges) {
                platformBridge = bridges[btype];
            }
        }
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createMethodsProxy(Intent, [
        ...
        , { methodName: 'stopListening', nativeName: 'stopListening', valueCallbackIndex: 0 }
          ...
          // function(/* optional function */ oResult)
        , { methodName: 'cleanStartParameters', nativeName: 'cleanStartParameters', valueCallbackIndex: 0 }
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createPropsProxy(System, [
      ...
      , { propName: 'RubyLocalServerURL', propAccess: 'r' }
